...
export const BLOG_POSTS: BlogPost[] = [
  {
    slug: "40000th-rescue-shikra",
    title: "Bird Number 40,000 — A Shikra Finds Her Way Home",
    excerpt:
      "We have crossed a milestone we once thought unimaginable. Our 40,000th rescue is a Shikra — a small but fierce Sparrow Hawk — brought to us injured and now on the road to recovery.",
    date: "2026-06-13",
    author: "Nadeem Shehzad",
    category: "Milestone",
    readTime: "3 min",
    image: "/blog/40000-shikra.jpeg",
    content: `Forty thousand.
...
Download the full 2025 report using the link above.`,
  },
  {
    ...
    title: "2025: Our Biggest Year Ever — 4,214 Birds Rescued",
    excerpt:
      "We shattered our previous record with 4,214 birds rescued in 2025. Read the full impact report — Scaling Avian Impact — covering our team, partners, and what's next.",
    date: "2026-01-15",
    author: "Nadeem Shehzad",
    category: "Annual Update",
    readTime: "5 min",
