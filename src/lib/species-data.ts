...
export const SPECIES_LIST: Species[] = [
  {
    ...
    image: "/species/black-kite-01.jpg",
    images: [
  ...
  },
  {
    ...
    videos: [
      ...
      { src: "/species/barn-owl-manja-bandage.mp4", caption: "A bandage being applied to a Barn Owl's wing — for a wound caused by entanglement in manja (glass-coated kite-flying thread). Even nocturnal birds aren't safe from manja, which stays strung across Delhi's skies long after kite-flying festivals end." },
    ],
  },
  {
