...
export default function BirdBrothersClient() {
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-lg max-w-none text-slate leading-relaxed space-y-4">
            ...
            <p className="text-charcoal font-semibold">
              Today, Wildlife Rescue has grown into one of the world&apos;s
              largest raptor rescue facilities, with over 41,000 birds rescued
              since 2010.
            </p>
          </div>
        </div>
      ...
      <section className="py-16 lg:py-24 bg-gradient-to-br from-teal to-teal-dark text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-4 text-white/80 max-w-2xl mx-auto leading-relaxed">
            This book tells the origin story of Wildlife Rescue — now one of
            the world&apos;s largest raptor rescue facilities, with over 41,000
            birds rescued since 2010. Nadeem and Saud continue their work every day in
