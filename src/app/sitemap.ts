...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE_URL}/clinic`, lastModified: now, changeFrequency: "monthly", priority: 0.7 },
    { url: `${BASE_URL}/enclosures`, lastModified: now, changeFrequency: "monthly", priority: 0.7 },
    ...
    { url: `${BASE_URL}/egyptian-vultures`, lastModified: now, changeFrequency: "monthly", priority: 0.7 },
    ...
    { url: `${BASE_URL}/education-outreach`, lastModified: now, changeFrequency: "monthly", priority: 0.6 },
    { url: `${BASE_URL}/blog`, lastModified: now, changeFrequency: "weekly", priority: 0.7 },
    { url: `${BASE_URL}/bird-brothers`, lastModified: now, changeFrequency: "yearly", priority: 0.5 },
